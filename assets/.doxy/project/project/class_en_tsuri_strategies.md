...
# Class EnTsuriStrategies



[**ClassList**](annotated.md) **>** [**EnTsuriStrategies**](class_en_tsuri_strategies.md)
...
```C++
virtual s32 EnTsuriStrategies::getStrategyId (
    int i_entityIdx
) 
```
...
------------------------------
The documentation for this class was generated from the following file `Project/sources/Sato/include/EnStrategy.h`
