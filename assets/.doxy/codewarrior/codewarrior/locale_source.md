...
[**File List**](files.md) **>** [**CodeWarrior**](dir_c5aab8d4319c0669f4501cae4cd3ca21.md) **>** [**PowerPC\_EABI\_Support**](dir_7a6c87a887c36ca33135c86474059f07.md) **>** [**Msl**](dir_7345a9473b198df67a564f445bc0d615.md) **>** [**MSL\_C++**](dir_bbcc9336d50f30308554b0fe78acfee6.md) **>** [**MSL\_Common**](dir_0c0c2b83f86d5caed54e8218e0fa784d.md) **>** [**Include**](dir_4b09b958bee5575b6e3a9125618b7d0e.md) **>** [**locale**](locale.md)

[Go to the documentation of this file](locale.md)


```C++
/*  Metrowerks Standard Library  Version 4.0  1998 August 10  */

/*  $Date: 1999/12/09 17:58:52 $ 
 *  $Revision: 1.12.6.1 $ 
 *  $NoKeywords: $ 
 *
...
#if __dest_os == __eppc_vxworks // ma 990824
...
public:
    ...
    static const category
        ...
        time     = LC_TIME, 
#ifndef _MSL_NO_LC_MESSAGES_SUPPORT
...
// has_facet
    ...
    {
        return __has_facet<Facet>(loc, __chooser<Facet::is_standard>());
    }
#else
    template <class Facet>
    inline
    ...
    {
        return __has_facet(loc, p, __chooser<Facet::is_standard>());
    }
#endif
...
num_put<charT, OutputIterator>::putdigits(ios_base& str, unsigned long val, charT* digits) const
{
        ...
        string_type& digits) const
    {
        ...
        digits = ct.widen(bcd.to_string(max<streamsize>(str.precision() + exponent + 1, 1), exponent));  // hh 980903
        if (exponent != bcd.exponent())  // hh 980902
            digits = ct.widen(bcd.to_string(max<streamsize>(str.precision() + exponent + 1, 1), exponent));
...
// ma 990824 not all CLIBs support locale messages; created _MSL_NO_LC_MESSAGES_SUPPORT
// ma 990824 Added ctype_base for VxWorks; undefine isalpha, etc.
