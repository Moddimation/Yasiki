...
[Go to the source code of this file](roundingf_8c_source.md)
...
| Type | Name |
| ---: | :--- |
|  float | [**ceilf**](#function-ceilf) (float x) <br> |
|  float | [**floorf**](#function-floorf) (float x) <br> |
...
------------------------------
The documentation for this class was generated from the following file `decomp/CodeWarrior/PowerPC_EABI_Support/Msl/MSL_C/MSL_Common_Embedded/Math/Single_precision/roundingf.c`
