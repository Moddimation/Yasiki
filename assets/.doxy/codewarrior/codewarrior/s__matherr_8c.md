...
[Go to the source code of this file](s__matherr_8c_source.md)
...
| Type | Name |
| ---: | :--- |
|  int | [**matherr**](#function-matherr) (struct [**exception**](structexception.md) \* x) <br> |
...
------------------------------
The documentation for this class was generated from the following file `decomp/CodeWarrior/PowerPC_EABI_Support/Msl/MSL_C/MSL_Common_Embedded/Math/Double_precision/s_matherr.c`
