...
[Go to the source code of this file](w__acos_8c_source.md)
...
| Type | Name |
| ---: | :--- |
|  double | [**acos**](#function-acos) (double x) <br> |
...
------------------------------
The documentation for this class was generated from the following file `CodeWarrior/PowerPC_EABI_Support/Msl/MSL_C/MSL_Common_Embedded/Math/Double_precision/w_acos.c`
