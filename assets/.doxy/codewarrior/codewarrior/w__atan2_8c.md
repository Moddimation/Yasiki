...
[Go to the source code of this file](w__atan2_8c_source.md)
...
| Type | Name |
| ---: | :--- |
|  double | [**atan2**](#function-atan2) (double y, double x) <br> |
...
------------------------------
The documentation for this class was generated from the following file `decomp/CodeWarrior/PowerPC_EABI_Support/Msl/MSL_C/MSL_Common_Embedded/Math/Double_precision/w_atan2.c`
