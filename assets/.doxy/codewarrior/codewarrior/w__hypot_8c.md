...
[Go to the source code of this file](w__hypot_8c_source.md)
...
| Type | Name |
| ---: | :--- |
|  double | [**hypot**](#function-hypot) (double x, double y) <br> |
...
------------------------------
The documentation for this class was generated from the following file `decomp/CodeWarrior/PowerPC_EABI_Support/Msl/MSL_C/MSL_Common_Embedded/Math/Double_precision/w_hypot.c`
