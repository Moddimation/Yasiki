...
[Go to the source code of this file](s__nextafter_8c_source.md)
...
| Type | Name |
| ---: | :--- |
|  double | [**nextafter**](#function-nextafter) (double x, double y) <br> |
...
------------------------------
The documentation for this class was generated from the following file `decomp/CodeWarrior/PowerPC_EABI_Support/Msl/MSL_C/MSL_Common_Embedded/Math/Double_precision/s_nextafter.c`
