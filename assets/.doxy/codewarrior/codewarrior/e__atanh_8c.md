...
[Go to the source code of this file](e__atanh_8c_source.md)
...
| Type | Name |
| ---: | :--- |
|  double | [**big**](#variable-big)   = `1e300`<br> |
...
| Type | Name |
| ---: | :--- |
|  double | [**\_\_ieee754\_atanh**](#function-__ieee754_atanh) (double x) <br> |
...
------------------------------
The documentation for this class was generated from the following file `CodeWarrior/PowerPC_EABI_Support/Msl/MSL_C/MSL_Common_Embedded/Math/Double_precision/e_atanh.c`
