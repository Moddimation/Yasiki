...
[**FileList**](files.md) **>** [**ax**](dir_465ede76f6332895dbe5336e4e51e527.md) **>** [**AXVPB.c**](_a_x_v_p_b_8c.md)
...
| Type | Name |
| ---: | :--- |
|  [**AXPB**](ax_8h.md#typedef-axpb) [**\_\_AXPB**](_c_a_r_d_private_8h.md#define-card_max_mount_step)[[**AX\_MAX\_VOICES**](ax_8h.md#define-ax_max_voices)] | [**ATTRIBUTE\_ALIGN**](#function-attribute_align) (32) <br> |
...
```C++
static AXPB  __AXPB [ AX_MAX_VOICES ] ATTRIBUTE_ALIGN (
    32
) 
```
...
------------------------------
The documentation for this class was generated from the following file `SDK/src/dolphin/ax/AXVPB.c`
