...
[**FileList**](files.md) **>** [**dolphin**](dir_8daa6a5f7f30f79e111d6992c13d512c.md) **>** [**dvd**](dir_89a52050841a8ad6d679d86dc07787eb.md) **>** [**dvdfs.c**](dvdfs_8c.md)
...
|  [**s32**](types_8h.md#typedef-s32) | [**DVDReadPrio**](#function-dvdreadprio) ([**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**DVDFileInfo**](struct_d_v_d_file_info.md) \* fileInfo, [**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step) \* addr, [**s32**](types_8h.md#typedef-s32) length, [**long**](_c_a_r_d_private_8h.md#define-card_max_mount_step) offset, [**long**](_c_a_r_d_private_8h.md#define-card_max_mount_step) prio) <br> |
|  [**int**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**DVDSeekAsyncPrio**](#function-dvdseekasyncprio) ([**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**DVDFileInfo**](struct_d_v_d_file_info.md) \* fileInfo, [**s32**](types_8h.md#typedef-s32) offset, [**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step)(\*)([**long**](_c_a_r_d_private_8h.md#define-card_max_mount_step), [**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**DVDFileInfo**](struct_d_v_d_file_info.md) \*) callback, [**long**](_c_a_r_d_private_8h.md#define-card_max_mount_step) prio) <br> |
|  [**s32**](types_8h.md#typedef-s32) | [**DVDSeekPrio**](#function-dvdseekprio) ([**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**DVDFileInfo**](struct_d_v_d_file_info.md) \* fileInfo, [**s32**](types_8h.md#typedef-s32) offset, [**long**](_c_a_r_d_private_8h.md#define-card_max_mount_step) prio) <br> |
...
|  [**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**cbForPrepareStreamSync**](#function-cbforpreparestreamsync) () <br> |
...
|  [**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**cbForReadSync**](#function-cbforreadsync) () <br> |
|  [**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**cbForSeekAsync**](#function-cbforseekasync) ([**s32**](types_8h.md#typedef-s32) result, [**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**DVDCommandBlock**](struct_d_v_d_command_block.md) \* block) <br> |
|  [**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**cbForSeekSync**](#function-cbforseeksync) () <br> |
...
| define  | [**offsetof**](dvdfs_8c.md#define-offsetof) (type, memb) `(([**u32**](types_8h.md#typedef-u32)) & ((type\*)0)-&gt;[**memb**](_c_a_r_d_private_8h.md#define-card_max_mount_step))`<br> |
...
int DVDSeekAsyncPrio (
    struct  DVDFileInfo * fileInfo,
    s32 offset,
    void (*)( long , struct  DVDFileInfo *) callback,
    long prio
) 
```
...
------------------------------
The documentation for this class was generated from the following file `SDK/src/dolphin/dvd/dvdfs.c`
