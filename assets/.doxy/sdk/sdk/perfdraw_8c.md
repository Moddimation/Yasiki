...
[**FileList**](files.md) **>** [**dolphin**](dir_8daa6a5f7f30f79e111d6992c13d512c.md) **>** [**perf**](dir_a39882d99c1d9edd3103bf7a0b2673d2.md) **>** [**perfdraw.c**](perfdraw_8c.md)
...
|  [**GXColor**](_g_x_struct_8h.md#typedef-gxcolor) | [**DrawFrameBGColor**](#variable-drawframebgcolor)   = `{ 0xC8, 0xC8, 0xC8, 0xC8 }`<br> |
|  [**GXColor**](_g_x_struct_8h.md#typedef-gxcolor) | [**DrawFrameColor**](#variable-drawframecolor)   = `{ 0x19, 0x19, 0x19, 0xC8 }`<br> |
|  [**float**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**DrawFrameH**](#variable-drawframeh)  <br> |
|  [**u32**](types_8h.md#typedef-u32) | [**DrawFrameMax**](#variable-drawframemax)  <br> |
|  [**float**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**DrawFrameW**](#variable-drawframew)   = `205.33333f`<br> |
...
|  [**u32**](types_8h.md#typedef-u32) | [**DrawNumFrames**](#variable-drawnumframes)   = `3`<br> |
...
|  [**u32**](types_8h.md#typedef-u32) | [**MaxBusTransactions**](#variable-maxbustransactions)  <br> |
...
| Type | Name |
| ---: | :--- |
|  [**WEAKFUNC**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**float**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**COORD**](#function-coord) ([**u32**](types_8h.md#typedef-u32) a) <br> |
|  [**WEAKFUNC**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**float**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**HEIGHT**](#function-height) ([**u32**](types_8h.md#typedef-u32) a, [**float**](_c_a_r_d_private_8h.md#define-card_max_mount_step) f) <br> |
...
### variable DrawFrameBGColor 

```C++
GXColor DrawFrameBGColor;
```
...
### variable MaxBusTransactions 

```C++
u32 MaxBusTransactions;
```
...
------------------------------
The documentation for this class was generated from the following file `SDK/src/dolphin/perf/perfdraw.c`
