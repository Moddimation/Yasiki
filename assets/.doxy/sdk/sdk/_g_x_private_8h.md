...
[**FileList**](files.md) **>** [**dolphin**](dir_8daa6a5f7f30f79e111d6992c13d512c.md) **>** [**gx**](dir_67427d996b492064997acb36f9dd3d39.md) **>** [**GXPrivate.h**](_g_x_private_8h.md)
...
| define  | [**GET\_REG\_FIELD**](_g_x_private_8h.md#define-get_reg_field) (reg, size, shift) `(([**int**](_c_a_r_d_private_8h.md#define-card_max_mount_step))(([**reg**](_c_a_r_d_private_8h.md#define-card_max_mount_step)) &gt;&gt; ([**shift**](_c_a_r_d_private_8h.md#define-card_max_mount_step))) & ((1 &lt;&lt; (size)) - 1))`<br> |
| define  | [**GX\_GET\_CP\_REG**](_g_x_private_8h.md#define-gx_get_cp_reg) (offset) `(\*([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)(([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)([**\_\_cpReg**](_g_x_init_8c.md#variable-__cpreg)) + (offset)))`<br> |
| define  | [**GX\_GET\_MEM\_REG**](_g_x_private_8h.md#define-gx_get_mem_reg) (offset) `(\*([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)(([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)([**\_\_memReg**](_g_x_init_8c.md#variable-__memreg)) + (offset)))`<br> |
| define  | [**GX\_GET\_PE\_REG**](_g_x_private_8h.md#define-gx_get_pe_reg) (offset) `(\*([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)(([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)([**\_\_peReg**](_g_x_init_8c.md#variable-__pereg)) + (offset)))`<br> |
| define  | [**GX\_GET\_PI\_REG**](_g_x_private_8h.md#define-gx_get_pi_reg) (offset) `(\*([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u32**](types_8h.md#typedef-u32)\*)(([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u32**](types_8h.md#typedef-u32)\*)([**\_\_piReg**](_g_x_init_8c.md#variable-__pireg)) + (offset)))`<br> |
| define  | [**GX\_SET\_CP\_REG**](_g_x_private_8h.md#define-gx_set_cp_reg) (offset, val) `(\*([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)(([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)([**\_\_cpReg**](_g_x_init_8c.md#variable-__cpreg)) + (offset)) = val)`<br> |
| define  | [**GX\_SET\_MEM\_REG**](_g_x_private_8h.md#define-gx_set_mem_reg) (offset, val) `(\*([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)(([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)([**\_\_memReg**](_g_x_init_8c.md#variable-__memreg)) + (offset)) = val)`<br> |
| define  | [**GX\_SET\_PE\_REG**](_g_x_private_8h.md#define-gx_set_pe_reg) (offset, val) `(\*([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)(([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u16**](types_8h.md#typedef-u16)\*)([**\_\_peReg**](_g_x_init_8c.md#variable-__pereg)) + (offset)) = val)`<br> |
| define  | [**GX\_SET\_PI\_REG**](_g_x_private_8h.md#define-gx_set_pi_reg) (offset, val) `(\*([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u32**](types_8h.md#typedef-u32)\*)(([**volatile**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**u32**](types_8h.md#typedef-u32)\*)([**\_\_piReg**](_g_x_init_8c.md#variable-__pireg)) + (offset)) = val)`<br> |
| define  | [**GX\_WRITE\_F32**](_g_x_private_8h.md#define-gx_write_f32) (f) `[**GXWGFifo.f32**](types_8h.md#typedef-f32) = ([**f32**](types_8h.md#typedef-f32))(f);`<br> |
...
| define  | [**GX\_WRITE\_U16**](_g_x_private_8h.md#define-gx_write_u16) (us) `[**GXWGFifo.u16**](types_8h.md#typedef-u16) = ([**u16**](types_8h.md#typedef-u16))([**us**](_c_a_r_d_private_8h.md#define-card_max_mount_step))`<br> |
| define  | [**GX\_WRITE\_U32**](_g_x_private_8h.md#define-gx_write_u32) (ui) `[**GXWGFifo.u32**](types_8h.md#typedef-u32) = ([**u32**](types_8h.md#typedef-u32))([**ui**](_c_a_r_d_private_8h.md#define-card_max_mount_step))`<br> |
| define  | [**GX\_WRITE\_U8**](_g_x_private_8h.md#define-gx_write_u8) (ub) `[**GXWGFifo.u8**](types_8h.md#typedef-u8) = ([**u8**](types_8h.md#typedef-u8))([**ub**](_c_a_r_d_private_8h.md#define-card_max_mount_step))`<br> |
...
#define GX_SET_CP_REG (
    offset,
    val
) `(*( volatile  u16 *)(( volatile  u16 *)( __cpReg ) + (offset)) = val)`
```
...
#define GX_SET_PE_REG (
    offset,
    val
) `(*( volatile  u16 *)(( volatile  u16 *)( __peReg ) + (offset)) = val)`
```
