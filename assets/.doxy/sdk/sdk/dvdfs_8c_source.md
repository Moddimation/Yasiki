...
[**File List**](files.md) **>** [**dolphin**](dir_8daa6a5f7f30f79e111d6992c13d512c.md) **>** [**dvd**](dir_89a52050841a8ad6d679d86dc07787eb.md) **>** [**dvdfs.c**](dvdfs_8c.md)
...
DVDSeekPrio (struct DVDFileInfo* fileInfo, s32 offset, long prio)
{
    ...
    block = &fileInfo->cb;
    result =
        DVDSeekAbsAsyncPrio (block, (u32)(u8*)fileInfo->startAddr + offset, cbForSeekSync, prio);
    if (!result)
    {
        return -1;
    }
