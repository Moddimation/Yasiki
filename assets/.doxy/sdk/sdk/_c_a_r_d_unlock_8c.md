...
[**FileList**](files.md) **>** [**card**](dir_490d43cfb0384f3832c2161c32949c06.md) **>** [**CARDUnlock.c**](_c_a_r_d_unlock_8c.md)
...
| Type | Name |
| ---: | :--- |
|  [**u8**](types_8h.md#typedef-u8) [**CardData**](_c_a_r_d_private_8h.md#define-card_max_mount_step)[352] | [**ATTRIBUTE\_ALIGN**](#function-attribute_align) (32) <br> |
...
```C++
static u8  CardData [352] ATTRIBUTE_ALIGN (
    32
) 
```
...
------------------------------
The documentation for this class was generated from the following file `SDK/src/dolphin/card/CARDUnlock.c`
