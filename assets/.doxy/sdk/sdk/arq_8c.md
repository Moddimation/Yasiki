...
[**FileList**](files.md) **>** [**ar**](dir_45272ec21184bd9fa1ffc8db46510f45.md) **>** [**arq.c**](arq_8c.md)
...
|  [**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**ARQRequest**](struct_a_r_q_request.md) \* | [**\_\_ARQRequestPendingHi**](#variable-__arqrequestpendinghi)  <br> |
|  [**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**ARQRequest**](struct_a_r_q_request.md) \* | [**\_\_ARQRequestPendingLo**](#variable-__arqrequestpendinglo)  <br> |
|  [**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**ARQRequest**](struct_a_r_q_request.md) \* | [**\_\_ARQRequestQueueHi**](#variable-__arqrequestqueuehi)  <br> |
|  [**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**ARQRequest**](struct_a_r_q_request.md) \* | [**\_\_ARQRequestQueueLo**](#variable-__arqrequestqueuelo)  <br> |
|  [**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**ARQRequest**](struct_a_r_q_request.md) \* | [**\_\_ARQRequestQueueTemp**](#variable-__arqrequestqueuetemp)  <br> |
|  [**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**ARQRequest**](struct_a_r_q_request.md) \* | [**\_\_ARQRequestTailHi**](#variable-__arqrequesttailhi)  <br> |
|  [**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**ARQRequest**](struct_a_r_q_request.md) \* | [**\_\_ARQRequestTailLo**](#variable-__arqrequesttaillo)  <br> |
|  [**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**ARQRequest**](struct_a_r_q_request.md) \* | [**\_\_ARQRequestTailTemp**](#variable-__arqrequesttailtemp)  <br> |
...
```C++
struct ARQRequest* __ARQRequestPendingHi;
```
...
```C++
struct ARQRequest* __ARQRequestPendingLo;
```
...
```C++
struct ARQRequest* __ARQRequestQueueHi;
```
...
```C++
struct ARQRequest* __ARQRequestQueueLo;
```
...
```C++
struct ARQRequest* __ARQRequestQueueTemp;
```
...
```C++
struct ARQRequest* __ARQRequestTailHi;
```
...
```C++
struct ARQRequest* __ARQRequestTailLo;
```
...
```C++
struct ARQRequest* __ARQRequestTailTemp;
```
...
------------------------------
The documentation for this class was generated from the following file `SDK/src/dolphin/ar/arq.c`
