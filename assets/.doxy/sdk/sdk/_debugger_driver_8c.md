...
[**FileList**](files.md) **>** [**OdemuExi2**](dir_6a7ebf6945b13b333fc1165e577c9bfd.md) **>** [**DebuggerDriver.c**](_debugger_driver_8c.md)
...
| Type | Name |
| ---: | :--- |
|  [**ONLY\_GLMJ01**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**CheckMailBox**](#function-checkmailbox) ([**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step)) <br> |
...
|  [**ONLY\_GLMJ01**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**DBGEXIClearInterrupts**](#function-dbgexiclearinterrupts) ([**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step)) <br> |
|  [**ONLY\_GLMJ01**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**BOOL**](types_8h.md#typedef-bool) | [**DBGEXIDeselect**](#function-dbgexideselect) ([**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step)) <br> |
...
|  [**ONLY\_GLMJ01**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**DBGEXIInit**](#function-dbgexiinit) ([**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step)) <br> |
|  [**ONLY\_GLMJ01**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**BOOL**](types_8h.md#typedef-bool) | [**DBGEXISelect**](#function-dbgexiselect) ([**u32**](types_8h.md#typedef-u32) v) <br> |
|  [**ONLY\_GLMJ01**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**BOOL**](types_8h.md#typedef-bool) | [**DBGEXISync**](#function-dbgexisync) ([**void**](_c_a_r_d_private_8h.md#define-card_max_mount_step)) <br> |
...
|  [**ONLY\_GLMJ01**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**BOOL**](types_8h.md#typedef-bool) | [**DBGWriteMailbox**](#function-dbgwritemailbox) ([**u32**](types_8h.md#typedef-u32) v) <br> |
...
|  [**int**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**DBWrite**](#function-dbwrite) ([**const**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**s32**](types_8h.md#typedef-s32) \* data, [**u32**](types_8h.md#typedef-u32) size) <br> |
...
```C++
ONLY_GLMJ01  void DBGEXIClearInterrupts (
    void
) 
```
...
```C++
ONLY_GLMJ01  BOOL DBGEXIDeselect (
    void
) 
```
...
```C++
ONLY_GLMJ01  BOOL DBGWriteMailbox (
    u32 v
) 
```
...
------------------------------
The documentation for this class was generated from the following file `SDK/src/OdemuExi2/DebuggerDriver.c`
