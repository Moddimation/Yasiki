...
[**FileList**](files.md) **>** [**ax**](dir_465ede76f6332895dbe5336e4e51e527.md) **>** [**AXAux.c**](_a_x_aux_8c.md)
...
| Type | Name |
| ---: | :--- |
|  [**s32**](types_8h.md#typedef-s32) [**\_\_AXBufferAuxA**](_c_a_r_d_private_8h.md#define-card_max_mount_step)[3][480] | [**ATTRIBUTE\_ALIGN**](#function-attribute_align) (32) <br> |
...
```C++
static s32  __AXBufferAuxA [3][480] ATTRIBUTE_ALIGN (
    32
) 
```
...
------------------------------
The documentation for this class was generated from the following file `SDK/src/dolphin/ax/AXAux.c`
