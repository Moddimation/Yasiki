...
[**File List**](files.md) **>** [**decomp**](dir_0c56b33aa00ddb0e63af648508d6e3f4.md) **>** [**DolphinSDK**](dir_7403dcf2df2f5392613493bf2b736904.md) **>** [**src**](dir_84dd7f8d193350365bcacfbd02904e42.md) **>** [**dolphin**](dir_099eac09ed7894d1733885fc00e718ed.md) **>** [**gx**](dir_b80c028b3e970eff7f2a07684ffcf104.md) **>** [**GXDraw.c**](_g_x_draw_8c.md)

[Go to the documentation of this file](_g_x_draw_8c.md)
...
GXDrawCubeFace (f32        nx,
                ...
                GXAttrType texture)
{
    GXPosition3f32 (0.57735026f * (nx + tx + bx),
                    0.57735026f * (ny + ty + by),
...
GXDrawOctahedron (void)
{
    ...
    for (i = 7; i >= 0; i--) { SubDivTriangle (0, (u8)i, odata, ondex); }
...
GXDrawIcosahedron (void)
{
    ...
    for (i = 19; i >= 0; i--) { SubDivTriangle (0, (u8)i, idata, index); }
...
GXDrawSphere1 (u8 depth)
{
    ...
    for (i = 19; i >= 0; i--) { SubDivTriangle (depth, (u8)i, idata, index); }
...
GXGenNormalTable (u8 depth, f32* table)
{
    ...
    for (i = 7; i >= 0; i--) { SubDivNrm (depth, (u8)i, odata, ondex); }
