...
[**File List**](files.md) **>** [**decomp**](dir_0c56b33aa00ddb0e63af648508d6e3f4.md) **>** [**DolphinSDK**](dir_7403dcf2df2f5392613493bf2b736904.md) **>** [**src**](dir_84dd7f8d193350365bcacfbd02904e42.md) **>** [**dolphin**](dir_099eac09ed7894d1733885fc00e718ed.md) **>** [**mcc**](dir_09af956a0e77733960814cc502aa891a.md) **>** [**fio.c**](fio_8c.md)

[Go to the documentation of this file](fio_8c.md)
...
static u16
EndianConvert16 (u16 n)
{
    return ((n & 0x00FF) << 8) | ((n & 0xFF00) >> 8);
}

static u32
EndianConvert32 (u32 n)
{
...
static void
fioMccChannelEvent (enum MCC_CHANNEL chID, u32 event, u32 value)
{
    u32 notify;
...
int
FIOInit (enum MCC_EXI exiChannel, enum MCC_CHANNEL chID, u8 blockSize)
{
...
fioPacketSendPacket (u8 sizeOfBlocks, void* pTopOfSecondBlockData)
{
    ...
    {
        gLastErr = 0x87;
        fioErrorReport ("fioPacketSendPacket.MCCNotify.NG"); // fake padding but idk
                                                             // whats going on here.
        return 0;
    }
    gLastErr = 0;
