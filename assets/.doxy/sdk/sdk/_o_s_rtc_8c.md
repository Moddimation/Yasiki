...
[**FileList**](files.md) **>** [**dolphin**](dir_8daa6a5f7f30f79e111d6992c13d512c.md) **>** [**os**](dir_8207759a5d5564400a58f6bb524771f0.md) **>** [**OSRtc.c**](_o_s_rtc_8c.md)
...
| Type | Name |
| ---: | :--- |
|  [**struct**](_c_a_r_d_private_8h.md#define-card_max_mount_step) [**SramControl**](struct_sram_control.md) [**Scb**](_c_a_r_d_private_8h.md#define-card_max_mount_step) | [**ATTRIBUTE\_ALIGN**](#function-attribute_align) (32) <br> |
...
```C++
static struct  SramControl  Scb ATTRIBUTE_ALIGN (
    32
) 
```
...
------------------------------
The documentation for this class was generated from the following file `SDK/src/dolphin/os/OSRtc.c`
