...
[**File List**](files.md) **>** [**card**](dir_490d43cfb0384f3832c2161c32949c06.md) **>** [**CARDWrite.c**](_c_a_r_d_write_8c.md)

[Go to the documentation of this file](_c_a_r_d_write_8c.md)
...
EraseCallback (s32 chan, long result)
{
    ...
    if (result >= 0)
    {
        ...
        result = __CARDWrite (chan,
                              card->sectorSize * fileInfo->iBlock,
                              card->sectorSize,
                              card->buffer,
                              WriteCallback);
        if (result < 0)
