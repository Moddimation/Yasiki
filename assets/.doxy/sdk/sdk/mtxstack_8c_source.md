...
[**File List**](files.md) **>** [**decomp**](dir_0c56b33aa00ddb0e63af648508d6e3f4.md) **>** [**DolphinSDK**](dir_7403dcf2df2f5392613493bf2b736904.md) **>** [**src**](dir_84dd7f8d193350365bcacfbd02904e42.md) **>** [**dolphin**](dir_099eac09ed7894d1733885fc00e718ed.md) **>** [**mtx**](dir_26b6e6c4cda21e7491fcc30d526d19d0.md) **>** [**mtxstack.c**](mtxstack_8c.md)

[Go to the documentation of this file](mtxstack_8c.md)
...
void
MTXInitStack (MTXStack* sPtr, u32 numMtx)
{
...
MTXPush (MTXStack* sPtr, Mtx m)
{
    ...
    ASSERTMSGLINE (0x66,
                   sPtr->stackBase,
                   "MTXPush():  'sPtr' contains a NULL ptr to stack memory ");
    ...
    {
        ASSERTMSGLINE (0x76,
                       ((((s32)sPtr->stackPtr - (s32)sPtr->stackBase) / 16) / 3) <
                           (sPtr->numMtx - 1),
                       "MTXPush():  stack overflow ");
...
MTXPushInvXpose (MTXStack* sPtr, Mtx m)
{
    ...
    else
    {
        ASSERTMSGLINE (0x129,
                       ((((s32)sPtr->stackPtr - (s32)sPtr->stackBase) / 16) / 3) <
                           (sPtr->numMtx - 1),
                       "MTXPushInvXpose():  stack overflow ");
...
MTXPop (MTXStack* sPtr)
{
    ...
    ASSERTMSGLINE (0x146,
                   sPtr->stackBase,
                   "MTXPop():  'sPtr' contains a NULL ptr to stack memory ");
    if (sPtr->stackPtr == NULL)
    {
        return NULL;
    }
