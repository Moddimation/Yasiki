...
// dvd.c
void DVDInit();
int  DVDReadAbsAsyncPrio(struct DVDCommandBlock* block, void* addr, s32 length,
                         long offset, void (*callback)(s32, struct DVDCommandBlock*),
                         s32 prio);
int  DVDSeekAbsAsyncPrio(struct DVDCommandBlock* block, s32 offset,
                         void (*callback)(s32, struct DVDCommandBlock*), s32 prio);
int  DVDReadAbsAsyncForBS(struct DVDCommandBlock* block, void* addr, s32 length,
                          long offset,
                          void (*callback)(s32, struct DVDCommandBlock*));
int  DVDReadDiskID(struct DVDCommandBlock* block, struct DVDDiskID* diskID,
                   void (*callback)(s32, struct DVDCommandBlock*));
int  DVDPrepareStreamAbsAsync(struct DVDCommandBlock* block, u32 length, u32 offset,
                              void (*callback)(s32, struct DVDCommandBlock*));
...
int DVDReadAbsAsyncPrio(struct DVDCommandBlock* block /* r29 */,
                        void* addr /* r1+0xC */, s32 length /* r1+0x10 */,
                        long offset /* r1+0x14 */,
