...
struct STRUCT_DEMOWIN* DEMOWinCreateWindow(s32 x1, s32 y1, s32 x2, s32 y2,
                                           char* caption, u16 scroll, void* func);
...
void DEMOWinSetWindowColor(struct STRUCT_DEMOWIN* handle, enum DEMOWinItem item,
                           u8 r, u8 g, u8 b, u8 a);
...
struct STRUCT_LISTBOX* DEMOWinCreateListWindow(struct STRUCT_LISTBOX* list, u16 x,
                                               u16 y);
