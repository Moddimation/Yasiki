...
OSAllocFixed(void* rstart, void* rend)
{
    ...
    ASSERTMSGLINE(0x1B3, ((u32)ArenaStart <= (u32)start) && ((u32)end <= (u32)ArenaEnd),
...
OSFreeToHeap(int heap, void* ptr)
{
    ...
    ASSERTMSGLINE(0x23F, ((u32)ArenaStart + 0x20) <= (u32)ptr && (u32)ptr < (u32)ArenaEnd,
...
OSReferentSize(void* ptr)
{
    ...
    ASSERTMSGLINE(0x3C6,
                  ((u32)HeapArray <= (u32)cell->hd) && ((u32)cell->hd < (u32)((u32)HeapArray + (NumHeaps * 0x18))),
