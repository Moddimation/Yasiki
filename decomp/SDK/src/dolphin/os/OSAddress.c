...
{
    ASSERTMSGLINE(0x4A, 0x80000000U <= (u32)caddr && (u32)caddr < 0x90000000U,
...
{
    ASSERTMSGLINE(0x59, 0xC0000000U <= (u32)ucaddr && (u32)ucaddr < 0xD0000000U,
...
{
    ASSERTMSGLINE(0x68, 0x80000000U <= (u32)caddr && (u32)caddr < 0x90000000U,
...
{
    ASSERTMSGLINE(0x77, 0xC0000000U <= (u32)ucaddr && (u32)ucaddr < 0xD0000000U,
