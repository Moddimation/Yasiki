...
MTXInitStack(MTXStack* sPtr, u32 numMtx)
{
    ...
    ASSERTMSGLINE(0x48, sPtr->stackBase,
...
MTXPush(MTXStack* sPtr, Mtx m)
{
    ...
    ASSERTMSGLINE(0x66, sPtr->stackBase,
...
MTXPushFwd(MTXStack* sPtr, Mtx m)
{
    ...
    ASSERTMSGLINE(0x9B, sPtr->stackBase,
...
MTXPushInv(MTXStack* sPtr, Mtx m)
{
    ...
    ASSERTMSGLINE(0xD6, sPtr->stackBase,
...
MTXPushInvXpose(MTXStack* sPtr, Mtx m)
{
    ...
    ASSERTMSGLINE(0x115, sPtr->stackBase,
...
MTXPop(MTXStack* sPtr)
{
    ...
    ASSERTMSGLINE(0x146, sPtr->stackBase,
...
MTXGetStackPtr(MTXStack* sPtr)
{
    ...
    ASSERTMSGLINE(0x16C, sPtr->stackBase,
