...
MTXFrustum (Mtx m, f32 t, f32 b, f32 l, f32 r, f32 n, f32 f)
{
    ...
    ASSERTMSGLINE (
        0x4D, t != b, "MTXFrustum():  't' and 'b' clipping planes are equal ");
    ASSERTMSGLINE (
        0x4E, l != r, "MTXFrustum():  'l' and 'r' clipping planes are equal ");
    ASSERTMSGLINE (
        0x4F, n != f, "MTXFrustum():  'n' and 'f' clipping planes are equal ");
    tmp = 1 / (r - l);
    m[0][0] = (2 * n * tmp);
    m[0][1] = 0;
    m[0][2] = (tmp * (r + l));
...
MTXOrtho (Mtx m, f32 t, f32 b, f32 l, f32 r, f32 n, f32 f)
{
    ...
    ASSERTMSGLINE (
        0xDC, t != b, "MTXOrtho():  't' and 'b' clipping planes are equal ");
    ASSERTMSGLINE (
        0xDD, l != r, "MTXOrtho():  'l' and 'r' clipping planes are equal ");
    ASSERTMSGLINE (
        0xDE, n != f, "MTXOrtho():  'n' and 'f' clipping planes are equal ");
    tmp = 1 / (r - l);
    m[0][0] = 2 * tmp;
    m[0][1] = 0;
    m[0][2] = 0;
