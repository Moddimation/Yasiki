               ...
               float crosstalk)
{
    ...
    if ((coloration < 0.0f) || (coloration > 1.0f) || (time < 0.01f) || (time > 10.0f) || (mix < 0.0f) || (mix > 1.0f)
        || (crosstalk < 0.0f) || (crosstalk > 1.0f) || (damping < 0.0f) || (damping > 1.0f) || (preDelay < 0.0f)
        || (preDelay > 0.1f))
    {
        return 0;
    }
...
DoCrossTalk(register long* l, register long* r, register float cross, register float invcross)
{
    nofralloc stwu r1, -48(r1)stfd f14, 40(r1)lis r5, i2fMagic @ha lfd f0, i2fMagic @l(r5) lis r5,
        ...
        stw      r5,
        8(r1)stw r5, 16(r1)stw r5, 24(r1)stw r5, 32(r1)ps_merge00 f3, invcross, cross ps_merge00 f4, cross,
        invcross lis r5, value0_6 @ha lfs f5, value0_6 @l(r5) li r5, 79 mtctr r5 li r10, -8 li r11, -4 ps_muls0 f4, f4,
        f5 lwz r6, 0(l)lwz r7, 0(r)xoris r6, r6, 0x8000 lwz r8, 4(l)xoris r7, r7, 0x8000 lwz r9, 4(r)xoris r8, r8,
        0x8000 stw r6, 12(r1)xoris r9, r9, 0x8000 stw r7, 20(r1)stw r8, 28(r1)stw r9, 36(r1)lfd f5, 8(r1)lfd f6,
        16(r1)fsubs f5, f5, f0 lfd f7, 24(r1)fsubs f6, f6, f0 lfd f8, 32(r1)fsubs f7, f7, f0 fsubs f8, f8,
...
HandleReverb(register long* sptr, register struct AXFX_REVHI_WORK* rv, register long k)
{
    nofralloc stwu r1, -0xc0(r1)stmw r14, 0x8(r1)stfd f14, 0x60(r1)stfd f15, 0x68(r1)stfd f16, 0x70(r1)stfd f17,
        ...
        0xa8(r1)stfd f24, 0xb0(r1)stfd f25, 0xb8(r1)stw k, 0x50(r1)stw rv, 0x54(r1)lis r31, value0_3 @ha lfs f6,
        value0_3 @l(r31) lis r31, value0_6 @ha lfs f9, value0_6 @l(r31) lis r31, i2fMagic @ha lfd f5,
        i2fMagic @l(r31) lfs f2, AXFX_REVHI_WORK.allPassCoeff(rv) lfs f15, AXFX_REVHI_WORK.damping(rv) lfs f8,
        AXFX_REVHI_WORK.level(rv) fmuls f3, f8, f9 fsubs f4, f9, f3 slwi r30, k, 1 add r30, r30, k mulli r31, r30,
        0x14 addi r29, rv, AXFX_REVHI_WORK.C add r29, r29, r31 addi r27, rv, AXFX_REVHI_WORK.AP add r27, r27,
        r31 slwi r31, r30, 2 add r31, r31, rv lfs f22, AXFX_REVHI_WORK.combCoef[0](r31) lfs f23,
        AXFX_REVHI_WORK.combCoef[1](r31) lfs f24, AXFX_REVHI_WORK.combCoef[2](r31) slwi r31, k, 2 add r31, r31,
        rv lfs f25, AXFX_REVHI_WORK.lpLastout[0](r31) lwz r31, AXFX_REVHI_WORK.preDelayTime(rv) lis r30, 0x4330 stw r30,
        0x58(r1)subi r22, r31, 1 slwi r22, r22, 2 slwi r28, k, 2 add r28, r28, rv cmpwi cr7, r31, 0 lwz r21,
