...
void
GXSetIndTexCoordScale (GXIndTexStageID ind_state,
                       ...
                       GXIndTexScale   scale_t)
{
    ...
    switch (ind_state)
    {
        ...
        default:
            ASSERTMSGLINE (
                0x102, 0, "GXSetIndTexCoordScale: Invalid Indirect Stage Id");
            break;
    }
    __GXData->bpSent = 1;
}
void
GXSetIndTexOrder (GXIndTexStageID ind_stage,
                  ...
                  GXTexMapID      tex_map)
{
    ...
    ASSERTMSGLINE (
        0x11D, tex_map < 8, "GXSetIndTexOrder: Invalid direct texture Id");
                 ...
                 GXIndTexAlphaSel alpha_sel)
{
    ...
    ASSERTMSGLINE (
        0x192, ind_stage < 4, "GXSetTevIndTile: Invalid indirect stage id");
    switch (tilesize_s)
    {
        case 256:
            wrap_s = GX_ITW_256;
        ...
        default:
            ASSERTMSGLINE (
                0x19B, 0, "GXSetTevIndTile: Invalid tilesize for S coordinate");
            wrap_s = GX_ITW_OFF;
            break;
    }
    switch (tilesize_t)
    {
        ...
        default:
            ASSERTMSGLINE (
                0x1A7, 0, "GXSetTevIndTile: Invalid tilesize for T coordinate");
            wrap_t = GX_ITW_OFF;
            break;
    }
...
void
GXSetTevIndBumpST (GXTevStageID    tev_stage,
                   GXIndTexStageID ind_stage,
                   GXIndTexMtxID   matrix_sel)
{
    GXIndTexMtxID sm;
    ...
    GXSetTevIndirect (
        tev_stage, ind_stage, GX_ITF_8, GX_ITB_ST, sm, GX_ITW_0, GX_ITW_0, 0U, 0, 0);
...
void
GXSetTevIndBumpXYZ (GXTevStageID    tev_stage,
                    GXIndTexStageID ind_stage,
                    GXIndTexMtxID   matrix_sel)
{
