...
void
GXSetTevIndirect(GXTevStageID tev_stage, GXIndTexStageID ind_stage, GXIndTexFormat format, GXIndTexBiasSel bias_sel,
...
GXSetIndTexMtx(GXIndTexMtxID mtx_id, f32 offset[2][3], s8 scale_exp)
{
    ...
    switch (mtx_id)
    {
        case GX_ITM_0 :
        case GX_ITM_1 :
        case GX_ITM_2  : id = mtx_id - 1; break;
        case GX_ITM_S0 :
        case GX_ITM_S1 :
        case GX_ITM_S2 : id = mtx_id - 5; break;
        case GX_ITM_T0 :
        case GX_ITM_T1 :
        case GX_ITM_T2 : id = mtx_id - 9; break;
        default        : id = 0; break;
    }
...
GXSetIndTexCoordScale(GXIndTexStageID ind_state, GXIndTexScale scale_s, GXIndTexScale scale_t)
{
    ...
    switch (ind_state)
    {
        ...
        case GX_INDTEXSTAGE3 :
            ...
            GX_WRITE_SOME_REG5(0x61, __GXData->IndTexScale1);
            break;
        default : ASSERTMSGLINE(0x102, 0, "GXSetIndTexCoordScale: Invalid Indirect Stage Id"); break;
    }
    __GXData->bpSent = 1;
}
...
GXSetIndTexOrder(GXIndTexStageID ind_stage, GXTexCoordID tex_coord, GXTexMapID tex_map)
{
    ...
    switch (ind_stage)
    {
        ...
        case GX_INDTEXSTAGE3 :
            ...
            break;
        default : ASSERTMSGLINE(0x132, 0, "GXSetIndTexOrder: Invalid Indirect Stage Id"); break;
    }
...
void
GXSetTevIndWarp(GXTevStageID tev_stage, GXIndTexStageID ind_stage, u8 signed_offset, u8 replace_mode,
                GXIndTexMtxID matrix_sel)
{
    GXIndTexWrap wrap = (replace_mode != 0) ? GX_ITW_0 : GX_ITW_OFF;

    CHECK_GXBEGIN(0x16E, "GXSetTevIndWarp");
    GXSetTevIndirect(tev_stage, ind_stage, GX_ITF_8, (signed_offset != 0) ? GX_ITB_STU : GX_ITB_NONE, matrix_sel, wrap,
                     wrap, 0U, 0, 0);
}
...
GXSetTevIndBumpST(GXTevStageID tev_stage, GXIndTexStageID ind_stage, GXIndTexMtxID matrix_sel)
{
    ...
    switch (matrix_sel)
    {
        ...
        case GX_ITM_2 :
            ...
            tm = GX_ITM_T2;
            break;
        default : ASSERTMSGLINE(0x1E0, 0, "GXSetTevIndBumpST: Invalid matrix selection"); break;
    }
...
__GXUpdateBPMask(void)
{
    ...
    for (i = 0; i < nIndStages; i++)
    {
        switch (i)
        {
            case 0 : tmap = GET_REG_FIELD(__GXData->iref, 3, 0); break;
            case 1 : tmap = GET_REG_FIELD(__GXData->iref, 3, 6); break;
            case 2 : tmap = GET_REG_FIELD(__GXData->iref, 3, 12); break;
            case 3 : tmap = GET_REG_FIELD(__GXData->iref, 3, 18); break;
        }
        new_imask |= 1 << tmap;
    }
