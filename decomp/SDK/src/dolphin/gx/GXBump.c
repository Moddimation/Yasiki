...
#endif
void
GXSetTevIndirect(GXTevStageID tev_stage, GXIndTexStageID ind_stage,
...
void
GXSetIndTexCoordScale(GXIndTexStageID ind_state, GXIndTexScale scale_s,
...
void
GXSetIndTexOrder(GXIndTexStageID ind_stage, GXTexCoordID tex_coord,
                 GXTexMapID tex_map)
{
...
void
GXSetTevIndWarp(GXTevStageID tev_stage, GXIndTexStageID ind_stage, u8 signed_offset,
                u8 replace_mode, GXIndTexMtxID matrix_sel)
{
    ...
    GXSetTevIndirect(tev_stage, ind_stage, GX_ITF_8,
                     (signed_offset != 0) ? GX_ITB_STU : GX_ITB_NONE, matrix_sel,
                     wrap, wrap, 0U, 0, 0);
}
void
GXSetTevIndTile(GXTevStageID tev_stage, GXIndTexStageID ind_stage, u16 tilesize_s,
...
void
GXSetTevIndBumpST(GXTevStageID tev_stage, GXIndTexStageID ind_stage,
                  GXIndTexMtxID matrix_sel)
{
    ...
    GXSetTevIndirect(tev_stage, ind_stage, GX_ITF_8, GX_ITB_ST, sm, GX_ITW_0,
                     GX_ITW_0, 0U, 0, 0);
    GXSetTevIndirect(tev_stage + 1, ind_stage, GX_ITF_8, GX_ITB_ST, tm, GX_ITW_0,
                     GX_ITW_0, 1U, 0, 0);
    GXSetTevIndirect(tev_stage + 2, ind_stage, GX_ITF_8, GX_ITB_NONE, GX_ITM_OFF,
                     GX_ITW_OFF, GX_ITW_OFF, 1U, 0, 0);
}
void
GXSetTevIndBumpXYZ(GXTevStageID tev_stage, GXIndTexStageID ind_stage,
                   GXIndTexMtxID matrix_sel)
{
