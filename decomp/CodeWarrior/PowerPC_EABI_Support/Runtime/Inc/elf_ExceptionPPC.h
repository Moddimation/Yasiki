...
#define ex_destroymembercond_MakeField(regcond, regpointer) (((regcond) << 7) | (((regpointer) & 0x0001) << 6))
...
#define ex_deletepointercond_MakeField(regcond, regpointer) (((regcond) << 7) | (((regpointer) & 0x0001) << 6))
...
#define ET_MakeField(savedGPRs, savedFPRs, savedCR, hasframeptr, isLarge)                                              \
    (((savedGPRs) << 11) | ((savedFPRs & 0x001f) << 6) | ((savedCR & 0x0001) << 5) | ((hasframeptr & 0x0001) << 4)     \
     | ((isLarge & 1) << 3))

#if __ALTIVEC__
#    define ET_AddHasVector(field, hasVector)       ((field) | ((hasVector & 1) << 2))
#    define ET_MakeVectorField(savedVRs, hasVRSAVE) (((savedVRs) << 11) | ((hasVRSAVE & 0x0001) << 10))
#endif
