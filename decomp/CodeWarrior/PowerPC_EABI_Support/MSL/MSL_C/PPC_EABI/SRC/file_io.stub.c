...
int
__read_file(__file_handle handle, unsigned char* buffer, size_t* count,
...
int
__write_file(__file_handle handle, unsigned char* buffer, size_t* count,
             __idle_proc idle_proc)
{
...
int
__position_file(__file_handle handle, fpos_t* position, int mode,
                __idle_proc idle_proc)
{
