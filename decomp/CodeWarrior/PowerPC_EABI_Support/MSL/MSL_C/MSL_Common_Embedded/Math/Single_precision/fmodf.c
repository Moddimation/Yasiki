...
fmodf(float x, float y)
{
    ...
    quotient
        >>= (31 - exp_shift); // truncates instead of round to nearest(this is correct since we want
                              ...
                              // multiply quotient term by 2^^exp_diff , if exp_diff > 32 this product will be rounded
                              // and will not be affected by the least significant bits of the original y.
