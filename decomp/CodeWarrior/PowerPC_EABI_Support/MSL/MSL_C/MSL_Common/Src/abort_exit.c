...
void exit(int status)		/*- cc 010326 -*/
{
...
#elif __dest_os == __ppc_eabi || __dest_os == __nec_eabi || __dest_os == __emb_68k || __dest_os == __mcore_bare || __dest_os == __dolphin_os /*- beb 990727 -*/
	_ExitProcess();													
#endif
