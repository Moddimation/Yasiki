...
__StopProgramBeforeExit()
{
    ...
    if (GetFileType(GetStdHandle(STD_OUTPUT_HANDLE)) == FILE_TYPE_CHAR)
    {
        ...
        /*- mdf 971019 -*/
        h = CreateFile("CONIN$", GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, &sa, OPEN_EXISTING,
                       NULL, NULL);
...
#elif __dest_os == __ppc_eabi || __dest_os == __nec_eabi || __dest_os == __emb_68k || __dest_os == __mcore_bare        \
