...
char * strdup(const char *str)			/*- 010725 -*/
{
		return __msl_strdup(str);
}

char * _strdup(const char *str)			/*- 010725 -*/
{
		return __msl_strdup(str);
}
...
int strnicmp(const char *s1, const char *s2, size_t n)			/*- cc 010713 -*/
{
...
int wtoi(const wchar_t *_a)     
{
	return wcstol(_a, NULL, 10);
}

int _wtoi(const wchar_t *_a)     
{
	return wcstol(_a, NULL, 10);
}
