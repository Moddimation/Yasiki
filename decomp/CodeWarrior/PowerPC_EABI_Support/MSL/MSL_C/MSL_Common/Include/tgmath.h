...
/* ldexp: when underflow code is enabled this will return results identical to the
exteneded precision fscale instruction on any x86 fpu 100% of the time. */

__inline float
ldexp (float x, _INT32 n)
{
    return ldexpf (x, n);
}
__inline float
...
#pragma cplusplus reset
        ...
        * targeting Mach-O        cc        010409 updated defines to JWW new namespace
        * macros
        */
