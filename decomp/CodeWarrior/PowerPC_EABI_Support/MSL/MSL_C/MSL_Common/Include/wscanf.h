...
_MSL_BEGIN_NAMESPACE_STD                                /*- cc 010409 -*/
    _MSL_BEGIN_EXTERN_C                                 /*- cc 010409 -*/
        ...
        _MSL_IMP_EXP_C int
                   fwscanf(FILE*, const wchar_t*, ...); /*- mf 990715 -*/
_MSL_IMP_EXP_C int wscanf(const wchar_t*, ...);
_MSL_IMP_EXP_C int swscanf(const wchar_t*, const wchar_t*, ...);
_MSL_IMP_EXP_C int vswscanf(const wchar_t*, const wchar_t*,
                            va_list);                   /*- mm 990921 -*/
_MSL_IMP_EXP_C int vfwscanf(FILE*, const wchar_t*, va_list);
/*- mf 990715 -*/                                       /*- mm 990921 -*/
...
_MSL_END_EXTERN_C                                       /*- cc 010409 -*/
    _MSL_END_NAMESPACE_STD                              /*- cc 010409 -*/
                                                         ...
                                                         * mm  990921 Changed __vswscanf and __vfwscanf to vswscanf and vfwscanf now that
                                                         * they are in C9x                                                     cc  010405
                                                         * removed pragma options align native and reset                                                     cc                                                     010409 updated defines to JWW
