...
_MSL_END_EXTERN_C /*- cc 010409 -*/
                   ...
                   *to mac only.               It is too late to add to win               will fix
                   *after pro6               cc               000828 made execl and               others common.
                   *JWW 001208 Added case for               targeting Mach-O               mm
                   *010119 Completed               change of mm 000607 for               write and
                   *for access               cc               010405 removed               pragma
                   *options               align               native and               reset               cc
                   *010409               updated defines to JWW               new namespace               macros
                   *cc               010427 Changed               exec               #defines to
                   *inlines               JWW               010510 Removed               special
                   *case               for               Mach-O
                   *- the               cname/name.h header split is               a               better fix               cc
                   *010517               Fixes getfamily to have void               in param and
                   *removed cast               to               int               cc               010517 Removed
                   *__BUILDING_MPW__ if else               cc  010622 Removed ifndef
