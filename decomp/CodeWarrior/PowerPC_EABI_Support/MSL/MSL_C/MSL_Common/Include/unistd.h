...
_MSL_BEGIN_EXTERN_C	/*- cc 010409 -*/
	...
	#define X_OK	1		/* Test for execute permission--temporary--don't know what
	                           value this should have --m.f. 000403   */	/*- mm 010626 -*/

	_MSL_IMP_EXP_C int   			chdir(const char*);
	...
	#else  
		__inline  int 				getpid(void) {return 9000;}				/*- cc 010517 -*/
	#endif
	
	__inline int 					getppid(void) 				{return 8000 ;}	/*- mm 990106 -*/	/*- cc 010517 -*/
	__inline int 					getuid(void) 				{return 200	 ;}	/*- mm 990106 -*/	/*- cc 010517 -*/
	__inline int 					geteuid(void) 				{return 200	 ;}	/*- mm 990106 -*/	/*- cc 010517 -*/
	__inline int 					getgid(void) 				{return 100  ;}	/*- mm 990106 -*/	/*- cc 010517 -*/
	__inline int 					getegid(void) 				{return 100  ;}	/*- mm 990106 -*/	/*- cc 010517 -*/
	__inline int 					getpgrp(void) 				{return 9000 ;}	/*- mm 990106 -*/	/*- cc 010517 -*/
	__inline int     	    		execl(const char *_a,...)  	{return exec(_a) ;}  	/*- cc 010427 -*/
	__inline int     	    		execv(const char *_a,...)  	{return exec(_a) ;}  	/*- cc 010427 -*/
	__inline int     	    		execle(const char *_a,...)  {return exec(_a) ;} 	/*- cc 010427 -*/
	__inline int     	    		execve(const char *_a,...)  {return exec(_a) ;} 	/*- cc 010427 -*/ 
	__inline int     	    		execlp(const char *_a,...)  {return exec(_a) ;} 	/*- cc 010427 -*/
	__inline int     	    		execvp(const char *_a,...)  {return exec(_a) ;} 	/*- cc 010427 -*/
