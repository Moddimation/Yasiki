...
void __convert_from_newlines (unsigned char* p,
                              __std (size_t) * n);    /*- hh 990121 -*/
void __convert_to_newlines (unsigned char* p, __std (size_t) * n);
void __prep_buffer (__std (FILE) *);                  /*- mf 990715 -*/
int  __load_buffer (__std (FILE) *,
                    __std (size_t) * bytes_loaded,
                    int alignment);                   /*- mf 990715 -*/
int  __flush_buffer (__std (FILE) *,
                     __std (size_t) * bytes_flushed); /*- mf 990715 -*/
