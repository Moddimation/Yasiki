...
#    }),
    ...
    DolphinLib("os", [
        ...
        (NonMatching, "OSAudioSystem.c"),
        (NonMatching, "OSCache.c"),
        (NonMatching, "OSContext.c"),
        (NonMatching, "OSError.c"),
        (NonMatching, "OSExi.c"),
        (NonMatching, "OSFont.c"),
        (NonMatching, "OSInterrupt.c"),
        (NonMatching, "OSLink.c"),
        (NonMatching, "OSMessage.c"),
        (NonMatching, "OSReboot.c"),
        (NonMatching, "OSMutex.c"),
        (NonMatching, "OSReset.c"),
        (NonMatching, "OSResetSW.c"),
        (NonMatching, "OSRtc.c"),
        (NonMatching, "OSSerial.c"),
        (NonMatching, "OSSync.c"),
        (Matching, "OSThread.c"),
        (Matching, "OSTime.c"),
