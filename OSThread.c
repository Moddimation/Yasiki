...
static inline void
InitMutexQueue(OSMutexQueue* queue)
{
 ...
 */
void
OSInitThreadQueue(OSThreadQueue* threadQueue)
{
 ...
 */
static OSThread*
SetEffectivePriority(OSThread* thread, OSPriority priority)
{
    switch (thread->state)
    {
 ...
 */
void
__OSPromoteThread(OSThread* thread, OSPriority priority)
{
    do {
        if (thread->suspend > 0)
        {
 ...
 */
BOOL
OSCreateThread(OSThread* thread, OSThreadStartFunction func, void* param,
 ...
 */
void
OSSleepThread(OSThreadQueue* threadQueue)
{
    BOOL      enabled;
    OSThread* currentThread;
 ...
 */
void
OSWakeupThread(OSThreadQueue* threadQueue)
{
    BOOL      enabled;
    OSThread* thread;
 ...
 */
BOOL
OSSetThreadPriority(OSThread*, s32)
{
    // UNUSED FUNCTION
}
/*
 ...
 */
OSThread*
OSSetIdleFunction(OSIdleFunction idleFunc, void* param, void* stack, u32 stackSize)
{
    // UNUSED FUNCTION
}
/*
